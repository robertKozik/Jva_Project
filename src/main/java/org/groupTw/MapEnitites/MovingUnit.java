...
abstract public class MovingUnit extends Entity implements iMovable {
    ...
    public MovingUnit(String imagePath_, int health_, int attack_) {
        super(imagePath_, health_, attack_);
        this.possible_moves = new ArrayList<>();
        evaluatePatterns();

    }

    public MovingUnit(Point position_, String imagePath_, int health_, int attack_) {
